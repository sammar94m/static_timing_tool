...
//
//template<typename T>
//void Table<T>::AddTable(int** table, MAXMIN AnlsType, Transitions Tr, int r,
//		int c) {
...
//
//template<typename T>
//T** Table<T>::GetTable(MAXMIN AnlsType, Transitions Tr, slope inslope,
//		load outload) {
//	return _16tables[pair<MAXMIN, Transitions>(AnlsType, Tr)];
//}
//
//template<typename T>
//T Table<T>::GetTableVal(MAXMIN AnlsType, Transitions Tr, slope inslope,
//		load outload) {
//	return _16tables[pair<MAXMIN, Transitions>(AnlsType, Tr)][inslope][outload];
//}
//
//template<typename T>
//T Table<T>::GetTableAV(MAXMIN AnlsType, Transitions Tr, unsigned int inslopeindex,
...
//
//template<typename T>
//T Table<T>::GetExtTableVal(MAXMIN AnlsType, Transitions Tr, slope inslope,
...
//
//template<typename T>
//T Table<T>::GetColDelta(MAXMIN AnlsType, Transitions Tr, unsigned int Col,
//		bool down) {
//	T Del;
...
//
//template<typename T>
//T Table<T>::GetRowDelta(MAXMIN AnlsType, Transitions Tr, unsigned int Row,
//		bool right) {
//	T Del;
